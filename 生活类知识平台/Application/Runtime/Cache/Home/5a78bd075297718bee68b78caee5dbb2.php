...
<head>
    ...
    <title>个人信息</title>
        ...
        <div >
            <a href="/xunmi/index.php/Home/Index/index">首页</a><span>&gt;</span><span style="color: red;">个人信息</span>
        </div>
        ...
        <section style="border:1px solid #e8cdb1;padding:6px;background:#fefefe;">
            <section style="border:1px dashed #e8cdb1;padding: 1em 3em 2em 1em;">
                <section data-autoskip="1" class="135brush" style="background:url(http://image2.135editor.com/cache/remote/aHR0cHM6Ly9tbWJpei5xbG9nby5jbi9tbWJpel9wbmcvN1FSVHZrSzJxQzZVSUczWlhNcGV5ODlEeG1pYVlUc0JpYTJlUldtU3hJUGljMmhPeXhUNVZ3Y3RpYmhBaWFSdHhMTkFOcmp3bVEwUW5yYjNzek1pYjNNaWEyS2JnLzA/d3hfZm10PXBuZw==)no-repeat;background-size:100px;background-position:bottom right; font-size: 14px;text-align: justify;letter-spacing: 1.5px;line-height: 1.75em;color: #3f3e3f;padding-bottom:2em;">
                    <p>
                        *用户名:<?php echo $_SESSION['username'];?><br/>
                    </p>
                    <p>
                        <br/>
                    </p>
                    <p>
                        *密码:&nbsp;<?php echo $_SESSION['user_password'];?>    <a href="/xunmi/index.php/Home/Userlogin/edit/id/<?php echo $_SESSION['user_id'];?>" style="text-decoration: none">修改密码</a><br/>
                    </p>
                    <p>
                        <br/>
                    </p>
                    <p>
                       <a href="/xunmi/index.php/Home/Zan/zan" target="_blank" style="text-decoration: none"> *喜欢:<span style="color: rgb(250, 144, 4)"><?php echo "$total1";?></span></a>
                    </p>
					<p>
                        <br/>
                    </p>
                    <p>
                        <a href="/xunmi/index.php/Home/Zan/collection" target="_blank"  style="text-decoration: none">*我的收藏:<span style="color: rgb(250, 144, 4)"><?php echo "$total2";?></span></a><br/>
                    </p>
