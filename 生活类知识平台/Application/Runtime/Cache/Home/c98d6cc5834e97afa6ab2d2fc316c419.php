...
<?php if($hots['h_id'] == 5 ||$hots['h_id'] == 8||$hots['h_id'] == 11): ?><div class="main" style="width: 1000px;height: 1500px;margin: 50px auto;max-width: 100%">
		 <?php if($hots['zan'] == 1 ): ?><a class="glyphicon glyphicon-thumbs-up zan" style="font-size:15px;text-decoration: none;cursor: pointer;color: red">点赞</a>
        ...
        <?php if($hots['collection'] ==1): ?><a class="glyphicon glyphicon-star-empty collection" style="font-size:15px;margin-top: 45px;text-decoration: none;cursor: pointer;margin-left: 25px;color:rgb(250, 247, 81)">收藏</a>
            <?php else: ?>
...
<div class="main" style="width: 600px;height: 1500px;margin: 50px auto;max-width: 100%">
		 <?php if($hots['zan'] == 1 ): ?><a class="glyphicon glyphicon-thumbs-up zan" style="font-size:15px;margin-top: 45px;text-decoration: none;cursor: pointer;color: red;">点赞</a>
    <?php else: ?><a class="glyphicon glyphicon-thumbs-up zan" style="font-size:15px;margin-top: 45px;text-decoration: none;cursor: pointer;">点赞</a><?php endif; ?>
    <?php if($hots['collection'] ==1): ?><a class="glyphicon glyphicon-star-empty collection" style="font-size:15px;margin-top: 45px;text-decoration: none;cursor: pointer;margin-left: 25px;color:rgb(250, 247, 81)">收藏</a>
        <?php else: ?>
        <a class="glyphicon glyphicon-star-empty collection" style="font-size:15px;margin-top: 45px;text-decoration: none;cursor: pointer;margin-left: 25px;">收藏</a><?php endif; ?>
        <?php echo htmlspecialchars_decode($hots['h_content']);?>
