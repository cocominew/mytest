...
<body>
 <header id="header">
    ...
    <section id="hothot" style="position: relative">
            <div class="container">
                <div class="row">
                        <?php if($total !=0): if(is_array($zan)): $i = 0; $__LIST__ = $zan;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-xs-12 col-sm-6 col-md-4">
                                        ...
                                        <div class="text">
                                            ...
                                            <div class="d">
                                                ...
                                                <div class="d2"><i class="glyphicon glyphicon-star-empty"
                                                        style="cursor:pointer" onclick="collection()"></i><span><?php echo ($vo["collection"]); ?></span></div>
                                            </div>
                                            <div class="author">
                            ...
                            </div><?php endforeach; endif; else: echo "" ;endif; ?><h5 class="text-muted" style="bottom: -51px;left: 42%;position: absolute;">共搜索到<?php echo "$total";?>条记录</h5><?php else: ?>
