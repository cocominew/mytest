...
<style type="text/css">
input{
    text-align: center;border: 1px solid;margin: 0px 350px;border-radius:25px;color: rgb(243, 117, 27);font-size: 25px 
}
.ci{margin-left: 0px;}
.ci1{margin-left: 0px;}
...
@media (max-width:768px){
    input{ margin: 0 120px;font-size: 18px;}
...
@media (min-width:768px) and (max-width:992px){
    input{ margin: 0 290px;font-size: 20px;}
...
<script type="text/javascript">
function qjj(){
	window.open("/xunmi/index.php/Home/Poem/content/id/1/#poem")
}
function ls(){
	window.open("/xunmi/index.php/Home/Poem/content/id/2/#poem")
}
function yjn(){
	window.open("/xunmi/index.php/Home/Poem/content/id/3/#poem")
}
</script>
<div class="play">
    <div class="pic">
        <img src="/xunmi/Public/Home/image/qiangjinjiu.jpg" id="qjj" onclick="qjj()" style="cursor: pointer"/>
        <img src="/xunmi/Public/Home/image/ls.jpg" id="ls" onclick="ls()" style="cursor: pointer"/>
        <img src="/xunmi/Public/Home/image/yjn.jpg" id="yjn" onclick="yjn()" style="cursor: pointer"/>
    </div>
    <div class="list">
        <ul>
            <li class="active"></li>
...
<input type="hidden" class="p" value="<?php echo ($poems["p_id"]); ?>"/>
<div class="main" style="width: 1000px;height: 1500px;margin: 50px auto;max-width:100%">
    <?php if($poems['zan'] == 1): ?><a class="glyphicon glyphicon-thumbs-up zan" style="font-size:15px;text-decoration: none;cursor: pointer;color: red">点赞</a>
    ...
    <?php if($poems['collection'] ==1): ?><a class="glyphicon glyphicon-star-empty collection" style="font-size:15px;margin-top: 45px;text-decoration: none;cursor: pointer;margin-left: 25px;color:rgb(250, 247, 81)">收藏</a>
        <?php else: ?>
