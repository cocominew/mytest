                        ...
                        <div class="panel-body">
                            <div class="p">
                                <div class="photo" style="height:235px;">
                                    <a href="/xunmi/index.php/Home/Festival/content/id/<?php echo ($vo["f_id"]); ?>/#festivial" target="_blank" class="a">
                                ...
                                <div class="text">
                                    ...
                                    <div class="d">
                                        ...
                                        <div class="d1"><a class="glyphicon glyphicon-thumbs-up zan" style="text-decoration: none">
                                        </a><span><?php echo ($vo["f_zan"]); ?></span>
                                </div>
                                        <div class="d2"><i class="glyphicon glyphicon-star-empty collection" style="text-decoration: none"></i><span><?php echo ($vo["f_collection"]); ?></span></div>
                                    </div>
                                    <div class="author">
