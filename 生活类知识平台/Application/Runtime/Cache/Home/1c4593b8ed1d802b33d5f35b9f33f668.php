                        ...
                        <div id="fenlei-content">
                            ...
                            <div class="content">
                                <object><a href="/xunmi/index.php/Home/Festival/index">节日习俗</a>
                                    ...
                                    <a href="/xunmi/index.php/Home/Mz/index">生活百科</a>
                        ...
                        <div class="panel-body">
                            <div class="p">
                                <div class="photo" style="height:235px;">
                                        <a href="/xunmi/index.php/Home/Mz/content/id/<?php echo ($vo["m_id"]); ?>/#sh" target="_blank" class="a">
                                            <?php if($vo['m_pic'] != null): ?><img src="/xunmi<?php echo ($vo["m_pic"]); ?>" height="235px" />    
                                            <?php else: ?>
                                            <img src="/xunmi/Uploads/2019-08-23/暂无图片.jpg" height="235px" /><?php endif; ?>
                                            </a>
                                </div>
                                <div class="text">
                                    <div class="t"><?php echo ($vo["m_title"]); ?></div>
                                    <div class="d">
                                        <div class="d1"><a class="glyphicon glyphicon-thumbs-up" style="text-decoration: none"
                                                id="like"></a><span><?php echo ($vo["zan"]); ?></span></div>
                                        <div class="d2"><i class="glyphicon glyphicon-star-empty" style="text-decoration: none"></i><span><?php echo ($vo["collection"]); ?></span></div>
                                    </div>
                                    <div class="author">
                                        <img width="24" height="24" src="/xunmi<?php echo ($vo["m_tou"]); ?>">
                                        <p style="color: #444;"><?php echo ($vo["m_author"]); ?><br><span>发布到 <?php echo ($vo["m_fabu"]); ?></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
