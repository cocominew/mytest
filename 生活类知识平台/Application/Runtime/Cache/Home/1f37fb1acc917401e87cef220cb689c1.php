...
<input type="submit" class="btn btn-primary" style="margin-top: 15px;" value="提交反馈"/>
        ...
        <section id="hothot" style="position: relative">
            <div class="container">
                <div class="row">
                    <?php if(is_array($col1)): foreach($col1 as $key=>$vo): ?><div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <?php if(is_array($col2)): foreach($col2 as $key=>$vo): ?><div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="panel-body">
                                <div class="p">
                                    <div class="photo" style="height:235px;">
                    ...
                    <?php if(is_array($col3)): foreach($col3 as $key=>$vo): ?><div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="panel-body">
                                <div class="p">
                                    <div class="photo" style="height:235px;">
                    ...
                    <?php if(is_array($col4)): foreach($col4 as $key=>$vo): ?><div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="panel-body">
                                <div class="p">
                                    <div class="photo" style="height:235px;">
                    ...
                    <?php if(is_array($col5)): foreach($col5 as $key=>$vo): ?><div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="panel-body">
                                <div class="p">
                                    <div class="photo" style="height:235px;">
                    ...
                    <?php if(is_array($col6)): foreach($col6 as $key=>$vo): ?><div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="panel-body">
                                <div class="p">
                                    <div class="photo" style="height:235px;">
                    ...
                    <?php if(is_array($col7)): foreach($col7 as $key=>$vo): ?><div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="panel-body">
                                <div class="p">
                                    <div class="photo" style="height:235px;">
