                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                                ...
                                <a href="/xunmi/index.php/Home/Userlogin/login" style="text-decoration: none"><div class="login" style="cursor: pointer">登录</div></a>
                            </div>
                    </div>
                </div>
        </header>
...
<div id="block" >
    ...
    <div class="block msgbox" style="z-index: 9011;position: fixed;padding: 0px;margin:-249px;width: 403px;height: 440px;top: 58%;left: 50%;background-color: white;">
            <div class="title">
                    <span>注册</span>
            ...
            <form action="" method="post">
                    ...
                    </div> <div style="margin: 116px 139px;">已有账号?&nbsp;&nbsp;&nbsp;<a class="denglu" id="checklog" style="cursor: pointer" href="/xunmi/index.php/Home/Userlogin/login">登录>></a></div>
                    </form>
    </div>
    </div>
    <div id="remen">
                                        ...
                                        <div class="text">
                                            ...
                                            <div class="d">
                                                <div class="d1"><a class="glyphicon glyphicon-thumbs-up zan"
                                                        style="cursor:pointer" ></a><span><?php echo ($vo["zan"]); ?></span></div>
                                                <div class="d2"><i class="glyphicon glyphicon-star-empty collection"
                                                        style="cursor:pointer"></i><span><?php echo ($vo["collection"]); ?></span></div>
                                            </div>
                                            <div class="author">
