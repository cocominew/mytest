...
<script type="text/javascript">
function yn(){
	window.open("/xunmi/index.php/Home/Trivial/content/id/1/#trivial")
}
function xm(){
	window.open("/xunmi/index.php/Home/Trivial/content/id/2/#trivial")
}
function sy(){
	window.open("/xunmi/index.php/Home/Trivial/content/id/3/#trivial")
}
$(document).ready(function(){
        $("#menpiao").mouseover(function(){
            $(".mp").show();
        })
        $("#menpiao").mouseout(function(){
            $(".mp").hide();
        })
    })
</script>
<div class="play">
    <div class="pic">
         <img src="/xunmi/Public/Home/image/yn.jpg" id="yn" onclick="yn()" style="cursor: pointer"/>
        <img src="/xunmi/Public/Home/image/xm.jpg" id="xm" onclick="xm()" style="cursor: pointer"/>
        <img src="/xunmi/Public/Home/image/sy.jpg" id="sy" onclick="sy()" style="cursor: pointer"/>
    </div>
    <div class="list">
        <ul>
            <li class="active"></li>
...
<input type="hidden" class="t" value="<?php echo ($trivials["t_id"]); ?>"/>
...
<?php if($trivials['t_id']==2 ||$trivials['t_id']==4 ): ?><div class="main" style="width: 800px;height: 1500px;margin-left: 130px;margin-top: 50px;max-width: 100%">
    <?php if($trivials['zan'] == 1): ?><a class="glyphicon glyphicon-thumbs-up zan" style="font-size:15px;text-decoration: none;cursor: pointer;color: red;margin-bottom: 20px;">点赞</a>
    <?php else: ?><a class="glyphicon glyphicon-thumbs-up zan" style="font-size:15px;text-decoration: none;cursor: pointer;margin-bottom: 20px;">点赞</a><?php endif; ?>
    <?php if($trivials['collection'] ==1): ?><a class="glyphicon glyphicon-star-empty collection" style="font-size:15px;margin-top: 45px;text-decoration: none;cursor: pointer;margin-left: 25px;color:rgb(250, 247, 81)">收藏</a>
        <?php else: ?>
...
<div class="main" style="width: 600px;height: 1500px;margin: 50px auto;max-width: 100%">
    <?php if($trivials['zan'] == 1): ?><a class="glyphicon glyphicon-thumbs-up zan" style="font-size:15px;text-decoration: none;cursor: pointer;color: red">点赞</a>
    ...
    <?php if($trivials['collection'] ==1): ?><a class="glyphicon glyphicon-star-empty collection" style="font-size:15px;margin-top: 45px;text-decoration: none;cursor: pointer;margin-left: 25px;color:rgb(250, 247, 81)">收藏</a>
        <?php else: ?>
        <a class="glyphicon glyphicon-star-empty collection" style="font-size:15px;margin-top: 45px;text-decoration: none;cursor: pointer;margin-left: 25px;">收藏</a><?php endif; ?>
		<?php echo htmlspecialchars_decode($trivials['t_content']); endif; ?>
</body>
</html>
<script type="text/javascript">
    $(".zan").click(function () {
