                        ...
                        <div class="panel-body">
                            <div class="p">
                                <div class="photo" style="height:235px;">
                                    <a href="/xunmi/index.php/Home/Trivial/content/id/<?php echo ($vo["t_id"]); ?>/#trivial" target="_blank" class="a">
                                        <?php if($vo['t_pic'] != null): ?><img src="/xunmi/<?php echo ($vo["t_pic"]); ?>"
                                                height="235px" style="cursor: pointer">
                                ...
                                <div class="text">
                                    ...
                                    <div class="d">
                                        <div class="d1"><a class="glyphicon glyphicon-thumbs-up" style="text-decoration: none"
                                        ></a><span><?php echo ($vo["t_zan"]); ?></span></div>
                                        <div class="d2"><i class="glyphicon glyphicon-star-empty" style="text-decoration: none"></i><span><?php echo ($vo["t_collection"]); ?></span></div>
                                    </div>
                                    <div class="author">
