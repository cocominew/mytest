...
<div class="play">
    <div class="pic">
        ...
        <img src="/xunmi/Public/Home/image/可乐鸡翅.jpg" id="kljc" onclick="kljc()" style="cursor: pointer"/>
...
<div id="remen" style="margin-top: -50px">
    ...
    <input type="hidden" class="f" value="<?php echo ($foods["f_id"]); ?>"/>
<div class="main" style="width: 1000px;height: 1500px;margin: 0px auto;max-width:100%">
    <?php if($foods['zan'] == 1): ?><a class="glyphicon glyphicon-thumbs-up zan" style="font-size:15px;text-decoration: none;cursor: pointer;color: red">点赞</a>
    ...
    <?php if($foods['collection'] ==1): ?><a class="glyphicon glyphicon-star-empty collection" style="font-size:15px;margin-top: 45px;text-decoration: none;cursor: pointer;margin-left: 25px;color:rgb(250, 247, 81)">收藏</a>
        <?php else: ?>
