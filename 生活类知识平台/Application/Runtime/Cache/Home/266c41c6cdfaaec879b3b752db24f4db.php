                        ...
                        <div class="panel-body">
                            <div class="p">
                                <div class="photo" style="height:235px;">
                                        <a href="/xunmi/index.php/Home/Sh/content/id/<?php echo ($vo["s_id"]); ?>/#sh" target="_blank" class="a">
                                ...
                                <div class="text">
                                    ...
                                    <div class="d">
                                        <div class="d1"><a class="glyphicon glyphicon-thumbs-up" style="text-decoration: none"
                                                id="like"></a><span><?php echo ($vo["s_zan"]); ?></span></div>
                                        <div class="d2"><i class="glyphicon glyphicon-star-empty" style="text-decoration: none"></i><span><?php echo ($vo["s_collection"]); ?></span></div>
                                    </div>
                                    <div class="author">
