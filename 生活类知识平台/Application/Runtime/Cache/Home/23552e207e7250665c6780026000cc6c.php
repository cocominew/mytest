...
<div id="remen" style="margin-top: -50px">
    ...
    <input type="hidden" class="m" value="<?php echo ($mzs["m_id"]); ?>"/>
<div class="main" style="width: 600px;height: 1500px;margin: 50px auto;max-width: 100%">
    <?php if($mzs['zan'] == 1): ?><a class="glyphicon glyphicon-thumbs-up zan" style="font-size:15px;text-decoration: none;cursor: pointer;color: red">点赞</a>
    ...
    <?php if($mzs['collection'] ==1): ?><a class="glyphicon glyphicon-star-empty collection" style="font-size:15px;margin-top: 45px;text-decoration: none;cursor: pointer;margin-left: 25px;color:rgb(250, 247, 81)">收藏</a>
        <?php else: ?>
