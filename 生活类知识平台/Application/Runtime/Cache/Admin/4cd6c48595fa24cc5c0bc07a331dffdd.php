                    ...
                    <a class="fenlei">分类
                        ...
                        <div id="fenlei-content">
                            <div class="fenlei-top">
                                <object><a href="/xunmi/index.php/Admin/Index/index/#remen" class="hot">热门推荐</a></object>
                            </div>
                            <div class="content">
                                <object><a href="/xunmi/index.php/Admin/Festival/index">节日习俗</a>
                                    <a href="/xunmi/index.php/Admin/Cook/index">家常菜谱</a>
                                    <a href="/xunmi/index.php/Admin/Trivial/index">旅游出行</a>
                                    <a href="/xunmi/index.php/Admin/Sh/index">生活百科</a>
                                    <a href="/xunmi/index.php/Admin/Poem/index">诗词</a>
                                    <a href="/xunmi/index.php/Admin/Game/index">娱乐</a></object>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-md-5">
                        <div class="dropdown" style="float:right;padding-top: 4px;margin: 20px 5px;">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1" style="min-width: 100%">
                                 <li><a href="/xunmi/index.php/Admin/Share/lst" target="_blank">分享作品</a></li>
                                 <li role="separator" class="divider"></li>
                                 <li><a href="/xunmi/index.php/Admin/Question/index" target="_blank">问题中心</a></li>
                                  <li role="separator" class="divider"></li>
                                  <li ><a id="feedback" style="cursor: pointer">意见反馈</a></li>
                                </ul>
                              </div>
                    <div style="float:right;padding-top: 4px;margin: 22px 35px;"><a href="/xunmi/index.php/Admin/Userlogin/logout">注销</a></div>
                    <div style="float:right;padding-top: 4px;color:#aedeab;margin: 22px 0px;">用户: <a href="/xunmi/index.php/Admin/Userlogin/info"><?php echo $_SESSION['username'];?></a></div>
            </div>
        </div>
        </div>
        </div>
...
<div class="main" style="width: 600px;height: 1500px;margin: 50px auto;max-width: 100%">
		...
		<?php echo htmlspecialchars_decode($shares['s_content']);?>
