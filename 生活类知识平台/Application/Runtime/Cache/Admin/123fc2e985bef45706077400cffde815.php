            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/xunmi/index.php/Admin/Mz/add"><i class="icon-font"></i>新增作品</a>
                ...
                <div class="result-content">
				   ...
				   <?php if(is_array($mzs)): $i = 0; $__LIST__ = $mzs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tc"><input name="id[]" value="58" type="checkbox"></td>
                            <td><?php echo ($vo["m_id"]); ?></td>
                            <td><?php echo ($vo["m_title"]); ?></td>
                            <td><?php echo ($vo["m_author"]); ?></td>
							<td>
							<?php if($vo['m_pic'] != null): ?><img src="/xunmi/<?php echo ($vo["m_pic"]); ?>" height="30"/>
							<?php else: ?>
							暂无图片<?php endif; ?>
							</td>
                            <td>
                                <a class="link-update" href="/xunmi/index.php/Admin/Mz/edit/id/<?php echo ($vo["m_id"]); ?>">修改</a>
                                <a class="link-del" href="/xunmi/index.php/Admin/Mz/del/id/<?php echo ($vo["m_id"]); ?>" onclick="return confirm('确定要删除 <?php echo ($vo["m_title"]); ?> 吗?');">删除</a>
                            </td>
