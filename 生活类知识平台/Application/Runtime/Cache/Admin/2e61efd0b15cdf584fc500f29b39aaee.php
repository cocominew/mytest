            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/xunmi/index.php/Admin/Game/add"><i class="icon-font"></i>新增作品</a>
                ...
                <div class="result-content">
				   ...
				   <?php if(is_array($games)): $i = 0; $__LIST__ = $games;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo["g_author"]); ?></td>
							 <td>
							<?php if($vo['g_pic'] != null): ?><img src="/xunmi/<?php echo ($vo["g_pic"]); ?>" height="30"/>
							<?php else: ?>
							暂无图片<?php endif; ?>
							</td>
                            <td>
                                <a class="link-update" href="/xunmi/index.php/Admin/Game/edit/id/<?php echo ($vo["g_id"]); ?>">修改</a>
                                <a class="link-del" href="/xunmi/index.php/Admin/Game/del/id/<?php echo ($vo["g_id"]); ?>" onclick="return confirm('确定要删除 <?php echo ($vo["g_title"]); ?> 吗?');">删除</a>
                            </td>
