...
<div class="topbar-wrap white">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/xunmi/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/xunmi/index.php/Admin/Hot/lst">热门推荐栏</a><span class="crumb-step">&gt;</span><span>修改作品</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
				<input type="hidden" name="h_id" value="<?php echo ($hots["h_id"]); ?>"/>
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>标题：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="<?php echo ($hots["h_title"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>作者：</th>
                                <td><input class="common-text" name="author" size="50" value="<?php echo ($hots["h_author"]); ?>" type="text"> 
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="require-red">*</i>头像：
								<input name="tou" id="" type="file" value="上传头像"><?php if($hots['h_tou'] != null): ?><img src="/xunmi<?php echo ($hots["h_tou"]); ?>" height="30"/>
							<?php else: ?>
							无头像<?php endif; ?></td>								
                            </tr>
                            <tr>
                             ...
                             <?php if($hots['h_pic'] != null): ?><img src="/xunmi<?php echo ($hots["h_pic"]); ?>" height="30"/>
							<?php else: ?>
							暂无图片<?php endif; ?></td>
							</tr>
                            <tr>
                                <th>内容：</th>
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo ($hots["h_content"]); ?></textarea></td>
                            </tr>
							 <tr>
                                <th>发布到：</th>
								<td>
...
$(document).ready(function(){
	$("#fb option[value='<?php echo ($hots["h_fabu"]); ?>']").attr("selected",true);
	})
</script>
