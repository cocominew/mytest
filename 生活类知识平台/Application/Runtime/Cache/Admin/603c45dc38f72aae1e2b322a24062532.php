...
<div class="topbar-wrap white">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/xunmi/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">作品审核</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-content">
				   ...
				   <?php if(is_array($shares)): $i = 0; $__LIST__ = $shares;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo["s_author"]); ?></td>
							 <td>
							<?php if($vo['s_pic'] != null): ?><img src="/xunmi/<?php echo ($vo["s_pic"]); ?>" height="30"/>
							<?php else: ?>
							暂无图片<?php endif; ?>
							</td>
                            <td>
                                <a href="/xunmi/index.php/Admin/Check/content/id/<?php echo ($vo["s_id"]); ?>">查看</a>
                                &nbsp;&nbsp;&nbsp;
                                <?php if($vo['s_pass']==0): ?><a class="link-update" href="/xunmi/index.php/Admin/Check/pass/id/<?php echo ($vo["s_id"]); ?>" onclick="pass()">通过</a>
                            <?php else: ?><span style="color: darkgray;">已通过</span><?php endif; ?>
                                &nbsp;&nbsp;&nbsp;
                                <a class="link-del" href="/xunmi/index.php/Admin/Check/del/id/<?php echo ($vo["s_id"]); ?>" onclick="return confirm('确定要删除 <?php echo ($vo["s_title"]); ?> 吗?');">删除</a>
                            </td>
