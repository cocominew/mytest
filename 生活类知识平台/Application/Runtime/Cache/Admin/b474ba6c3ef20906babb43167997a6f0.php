...
<div class="topbar-wrap white">
            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="/xunmi/index.php/Admin/Mz/lst"><i class="icon-font">&#xe005;</i>生活百科栏</a></li>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/xunmi/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/xunmi/index.php/Admin/Mz/lst">美妆护肤栏</a><span class="crumb-step">&gt;</span><span>修改作品</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
				<input type="hidden" name="m_id" value="<?php echo ($mzs["m_id"]); ?>"/>
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>标题：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="<?php echo ($mzs["m_title"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>作者：</th>
                                <td><input class="common-text" name="author" size="50" value="<?php echo ($mzs["m_author"]); ?>" type="text">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="require-red">*</i>头像：
								<input name="tou" id="" type="file" value="上传头像"><?php if($mzs['m_tou'] != null): ?><img src="/xunmi<?php echo ($mzs["m_tou"]); ?>" height="30"/>
							<?php else: ?>
							无头像<?php endif; ?>
								</td>
                            </tr>
                            <tr>
                             ...
                             <?php if($mzs['m_pic'] != null): ?><img src="/xunmi<?php echo ($mzs["m_pic"]); ?>" height="30"/>
							<?php else: ?>
							暂无图片<?php endif; ?></td>
							</tr>
                            <tr>
                                <th>内容：</th>
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo ($mzs["m_content"]); ?></textarea></td>
                            </tr>
							<tr>
                                <th>发布到：</th>
								<td>
...
$(document).ready(function(){
	$("#fb option[value='<?php echo ($mzs["m_fabu"]); ?>']").attr("selected",true);
	})
</script>
