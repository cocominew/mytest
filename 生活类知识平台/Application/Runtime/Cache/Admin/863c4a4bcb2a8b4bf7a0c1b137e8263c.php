...
<div class="topbar-wrap white">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/xunmi/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/xunmi/index.php/Admin/Mz/lst">美妆护肤栏</a><span class="crumb-step">&gt;</span><span>新增作品</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
							...
							<tr>
								...
								<option>家常菜谱</option>
								<option>旅游出行</option>
								<option selected="selected">美妆护肤</option>
								<option>诗词</option>
								<option>娱乐</option>
								</select>
								</td>
