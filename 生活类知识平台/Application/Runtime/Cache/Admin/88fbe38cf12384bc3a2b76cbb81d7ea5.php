            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/xunmi/index.php/Admin/Festival/add"><i class="icon-font"></i>新增作品</a>
                ...
                <div class="result-content">
                   ...
                   <?php if(is_array($festivals)): $i = 0; $__LIST__ = $festivals;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tc"><input name="id[]" value="58" type="checkbox"></td>
                            <td><?php echo ($vo["f_id"]); ?></td>
							<td><?php echo ($vo["f_title"]); ?></td>
                            <td><?php echo ($vo["f_author"]); ?></td>
                            <td>
							<?php if($vo['f_pic'] != null): ?><img src="/xunmi/<?php echo ($vo["f_pic"]); ?>" height="30"/>
							<?php else: ?>
							暂无图片<?php endif; ?>
							</td>
                            <td>
                                <a class="link-update" href="/xunmi/index.php/Admin/Festival/edit/id/<?php echo ($vo["f_id"]); ?>">修改</a>
                                <a class="link-del" href="/xunmi/index.php/Admin/Festival/del/id/<?php echo ($vo["f_id"]); ?>" onclick="return confirm('确定要删除 <?php echo ($vo["f_title"]); ?> 吗?');">删除</a>
                            </td>
